...
def compare_scores(args, dasharo_image, proprietary_image):
...
def export_compared_data(args, dasharo_image, proprietary_image):
    ...
    closed_source_diff, data_size_diff, empty_diff = compare_scores(args, dasharo_image, proprietary_image)
    ...
    if Path(output_file).is_file():
        ...
        with open(output_file, 'w') as md:
            ...
            md.write("|Platform | Dasharo Firmware file | Proprietary Firmware file | closed-source diff [MB(%)] | data size diff [MB(%)] | empty space diff [MB(%)] |\n")
            md.write("| --- | --- | --- | --- | --- | --- |\n")
            md.write("| %s | %s | %s | %s | %s | %s |\n" % (args.platform, dasharo_name, proprietary_name, closed_source_diff, data_size_diff, empty_diff))
